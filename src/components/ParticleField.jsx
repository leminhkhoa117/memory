...
const createParticleOptions = ({ intense }) => ({
...
const ambientParticleOptions = createParticleOptions({ intense: false })
const intenseParticleOptions = createParticleOptions({ intense: true })
...
function ParticleField({ id, intense = false }) {
  ...
  return (
    <div className={`particle-field ${intense ? 'particle-field--intense' : ''}`} aria-hidden="true">
      <Particles
        id={id}
        options={intense ? intenseParticleOptions : ambientParticleOptions}
      />
